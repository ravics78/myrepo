...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "MyOTTApp@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "MyOTTApp API";

        private String description = "MyOTTApp API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "MyOTTApp";
